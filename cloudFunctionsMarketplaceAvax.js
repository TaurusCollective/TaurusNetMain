...
Moralis.Cloud.define("getUserItemsAvax", async (request) => {
...
Moralis.Cloud.beforeSave("ItemsForSaleAVAX", async (request) => {
  const query = new Moralis.Query("AvaxNFTOwners");
...
Moralis.Cloud.beforeSave("SoldItemsAVAX", async (request) => {
  const query = new Moralis.Query("ItemsForSaleAVAX");
...
Moralis.Cloud.define("getItemsAvax", async (request) => {
  const query = new Moralis.Query("ItemsForSaleAVAX");
